...
const pages = {
    ...
    "cogram": {title: "סכוּמילים", alt: "Cograms and codromes", kw: ["2d 3d", "cipher", "combined forms", "computational", "hebrew cheatery", "new constraint", "palindrome"]},
    ...
    "medovev/": {title: "המדובב (בודק פלינדרומים)", alt: "Medovev (palindrome checker)", kw: ["interactive", "palindrome", "pangram", "tool"]},
    ...
    "pangrams": {title: "פנגרמות מושלמות מינימליות", alt: "Minimal perfect pangrams", kw: ["combinatorial", "combined forms", "computational", "hebrew cheatery", "new constraint", "pangram", "record"]},
    ...
    "pan2d": {title: "פנגרמה מושלמת דו־ממדית", alt: "2D perfect pangram", kw: ["2d 3d", "cipher", "combinatorial", "combined forms", "computational", "hebrew cheatery", "new constraint", "pangram", "poem", "record", "visual"]},
    "pan3d/": {title: "פנגרמה מושלמת תלת־ממדית", alt: "3D perfect pangram", kw: ["2d 3d", "combinatorial", "combined forms", "computational", "hebrew cheatery", "new constraint", "pangram", "poem", "record", "self-referral", "visual"]},
    "snark/": {title: "כרחש אבמ\"ח וכרחש אדו\"ש", alt: "ABMḤ snark and ADWŠ snark", kw: ["2d 3d", "combinatorial", "computational", "interactive", "new constraint", "pangram", "sound", "visual"]},
    "wordle": {title: "תחפצו ניעקד אסכלה משרבט", alt: "Words for Wordle", kw: ["combinatorial", "computational", "pangram"]},
    "eyal": {title: "אֱיָליטרציה", alt: "Eyalliteration", kw: ["2d 3d", "combined forms", "discourse", "poem", "self-referral", "visual"]},
    "tri": {title: "מילה משולשת בת 15 אותיות", alt: "15-letter triangle word", kw: ["record"]},
    ...
    "otomat/": {title: "אות־וֹמט תאי", alt: "OT‑o‑mata: Letter cellular automata", kw: ["2d 3d", "computational", "interactive", "live code", "new constraint", "self-referral", "visual"], hazard: "flashing"},
    "xx17n": {title: "חרותת / xx17n", alt: "xx17n", kw: ["cipher", "poem", "visual"]},
    "compact/": {title: "דחיסות אורתוגרפית", alt: "Orthographic compactness", kw: ["computational", "data available", "hebrew cheatery"]},
    "freq": {title: "שכיחות האותיות בספרות העברית", alt: "Letter frequencies in Hebrew literature", kw: ["computational", "data available"]},
    "taz": {title: "תחום אוטונומי זמני", alt: "Temporary Autonomous Zone", kw: ["cipher", "computational", "new constraint", "poem", "sound", "visual"]},
    "shirbert": {title: "שירבֵּרט", alt: "ShirBERT", kw: ["computational", "generative", "poem", "tool"]},
    ...
    "barosh/": {title: "בראש יתברא / יתד בקלשוני", alt: "BaRosh Yitbare / Yated BeKilshoni", kw: ["biblical", "combinatorial", "computational", "data available", "interactive", "live code", "record", "visual"]},
    ...
    "a_": {title: "א_", kw: ["cipher", "combined forms", "computational", "new constraint", "poem"], wip: true},
}
...
function is_shortcut(event, shortcut, ignore_mod) {
    ...
    return event_key == shortcut_key && (ignore_mod || event.shiftKey == shortcut.includes('shift') && (event.ctrlKey != global_is_mac && event.metaKey == global_is_mac) == (shortcut.includes('ctrl') || shortcut.includes('cmd') || shortcut.includes('command')) && (event.getModifierState?.('AltGraph') || event.altKey) == (shortcut.includes('alt') || shortcut.includes('opt')))
}
